...
# Selects the NodePort offset in main.tf's version_offset map so each parallel version job gets a
# unique port pair. Passed in per-job by python-eks-parallel-test.yml.
